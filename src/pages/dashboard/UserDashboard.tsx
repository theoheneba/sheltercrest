...
import { 
  ...
  Upload, Download, Eye, MessageSquare, Bell
} from 'lucide-react';
...
const UserDashboard = () => {
  ...
  const lateFee = calculateLatePaymentFee(monthlyRent, currentDayOfMonth);
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        <li className="flex items-center">
                          ...
                          <span>Regular period: 28th - 3rd</span>
                        </li>
                        <li className="flex items-center">
                          <div className="w-3 h-3 rounded-full bg-yellow-500 mr-2"></div>
                          <span>4th - 10th: +10% fee</span>
                        </li>
                        <li className="flex items-center">
                          <div className="w-3 h-3 rounded-full bg-orange-500 mr-2"></div>
                          <span>11th - 18th: +15% fee</span>
                        </li>
                        <li className="flex items-center">
                          <div className="w-3 h-3 rounded-full bg-red-500 mr-2"></div>
                          <span>19th - 25th: +25% fee</span>
                        </li>
                      </ul>
                    </div>
                  </div>
