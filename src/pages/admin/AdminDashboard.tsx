...
const stats = {
  ...
  recentApplications: [
    { id: 'APP001', name: 'John Doe', amount: 1200, status: 'pending', date: '2025-04-10' },
    { id: 'APP002', name: 'Jane Smith', amount: 1500, status: 'pending', date: '2025-04-10' },
    { id: 'APP003', name: 'Mike Johnson', amount: 800, status: 'pending', date: '2025-04-09' }
  ],
  performanceMetrics: {
    approvalRate: 85,
