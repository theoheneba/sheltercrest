/*
  # Add Buy Now Pay Later Tables

  1. New Tables
    - `products`
      - Product catalog for BNPL items
      - Includes furniture, appliances, and electronics
    - `product_categories` 
      - Categories for organizing products
    - `orders`
      - BNPL purchase orders
      - Links to applications for verification
    - `order_items`
      - Individual items in each order
    - `bnpl_payments`
      - Payment schedules for BNPL purchases
  ...
  3. Changes
    - Add BNPL-related fields to applications table
*/
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  payment_term integer NOT NULL, -- Number of months
